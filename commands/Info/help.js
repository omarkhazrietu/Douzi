  ...
  run: async (client, message, args) => {
    try {
      ...
      if (args[0] && args[0].length > 0) {
        ...
        const embed = new MessageEmbed()
          .setColor(ee.color)
          .setThumbnail('https://cdn.discordapp.com/attachments/589338815869747203/888911743017959424/images.jpg')
      ...
      return message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(ee.footertext, 'https://cdn.discordapp.com/attachments/589338815869747203/888911743017959424/images.jpg')
